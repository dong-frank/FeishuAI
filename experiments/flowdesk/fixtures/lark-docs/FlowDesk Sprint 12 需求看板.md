...
| New Dev | 陈宇航 | 新加入团队的开发者，今天领取 FD-124 |
...
- New Dev 陈宇航领取 FD-124，站会结束后回到终端开始开发。

## Sprint 看板

| Story ID | 标题 | 状态 | 优先级 | 负责人 | 协作开发者 | Reviewer | 分支名 | Review 会议 | 验收标准 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| FD-118 | 工单状态变更写入审计事件 | 已完成 | P2 | 许嘉宁 | 陈宇航 | 周启明 | feature/fd-118-ticket-audit | 已完成 | 状态变更能记录 actor 和 action |
| FD-121 | 支持负责人按 assignee 查看工单 | 已完成 | P2 | 许嘉宁 | - | 周启明 | feature/fd-121-assignee-filter | 已完成 | 支持负责人可按 assignee 缩小列表 |
| FD-123 | 调整工单列表默认排序 | 开发中 | P1 | 许嘉宁 | 陈宇航 | 周启明 | feature/fd-123-priority-sort | 2026-04-29 16:00 | 高优先级工单应排在列表前面 |
| FD-124 | 工单列表支持按优先级筛选 | 开发中 | P1 | 陈宇航 | 许嘉宁 | 许嘉宁 | feature/fd-124-priority-filter | 待约定 | 用户可按 High / Medium / Low 筛选工单 |
