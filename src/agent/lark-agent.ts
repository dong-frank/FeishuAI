...
目前支持的 topic 是 "commit_message_policy"、"troubleshooting_reference" 和 "development_record_guidance"。
...
- topic: "commit_message_policy" | "troubleshooting_reference" | "development_record_guidance"
- content: 字符串
